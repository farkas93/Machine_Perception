...
if __name__ == '__main__':
    ...
    with tf.Session(config=session_config) as session:
        ...
        batch_size = ffab_config['batch_size']
        learning_rate = ffab_config['learning_rate']
        data_to_retrieve = ['face', 'gaze']  # Available are: left-eye
                                                         #                right-eye
                                                         #                eye-region
                                                         #                face
                                                         #                gaze (required)
        ...
        from models.ffabnet import FfabNet
        model = FfabNet(
            # Tensorflow session
            ...
            learning_schedule=[
                {
                    'loss_terms_to_optimize': ffab_config['loss_terms'],
                    'metrics': ffab_config['metrics'],
                    'learning_rate': learning_rate,
                },
            ],

            test_losses_or_metrics=[ffab_config['loss_terms'], ffab_config['metrics']],
