...
if __name__ == '__main__':
    ...
    with tf.Session(config=session_config) as session:
        ...
        batch_size = alex_config['batch_size']
        learning_rate = alex_config['learning_rate']
        data_to_retrieve = [alex_config['eye_patch'], 'gaze', 'head']  # Available are: left-eye
                                                         #                right-eye
                                                         #                eye-region
                                                         #                face
                                                         #                gaze (required)
        ...
        model = AlexNet(
            ...
            learning_schedule=[
                {
                    'loss_terms_to_optimize': alex_config['loss_terms'],
                    'metrics': alex_config['metrics'],
                    'learning_rate': learning_rate,
                },
            ],

            test_losses_or_metrics=[alex_config['loss_terms'][0], alex_config['metrics'][0]],
